...
<head>
    ...
    <style>
        body {
            background-image: url('{{ asset('images/on-cua-bts-la-ca-khuc-kpop-duoc-tim-kiem-nhieu-nhat-tren-ung-dung-nhan-dien-nhac-shazam-2e8-5089670.jpg') }}');
...
<body>
    <h1>Các bài hát được tìm kiếm nhiều nhất</h1>
    <ul>
        @foreach ($mostSearchedSongs as $song)
            <li>{{ $song->title }} (Search Count: {{ $song->search_count }})</li>
